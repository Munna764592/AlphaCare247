...
const Navbar = () => {
    ...
    const { CheckLogin, UserLogout, OpenLogin, OpenLoginFun } = useLabContext();
    const RenderMenu = () => {
        if (CheckLogin) {
            return (
                <>
                    <div className="action">
                        ...
                        <div className={expandprofile ? "menu-login" : "menu-login active"}>
                            ...
                            <ul>
                                ...
                                <li onClick={() => logout()}><img src={require("../images/log-out.png")} /><a onClick={() => { userlogout(); UserLogout(false) }}>Logout</a></li>
                            </ul>
                        </div>
                    </div>
                </>
            ...
            return (
                <>
                    <div style={{ marginTop: "3px" }} className="mr-6 d-flex nav-logsign">
                        <Link onClick={(window.innerWidth <= 890) ? () => { setopenLogin(true); updateMenu() } : () => { setopenLogin(true) }} style={{ color: '#02bdb4', fontWeight: "700" }} className="login nav-link">LOGIN/SIGNUP</Link>
                        <div className='cart'>
                            <span className='cart-circle'>5</span>
                            <i className="fa-xl fa-solid fa-bag-shopping"></i>
                        </div>
    ...
    return (
        <>
            <div style={{ position: "relative" }}>
                <div className='nav-top'>
                    <header className="header">
                        <div style={{ opacity: "0.9" }}>
                            ...
                            <a className='ml-1' style={{ color: "white" }} href='tel:+918377895401'>
                                +918377895401
                            </a>
                            <span className='nav-no'>, </span>
                            <a className='nav-no' style={{ color: "white" }} href='tel:+91837789404'>
                                +91837789404
                            </a>
                        </div>
                        <div style={{ opacity: "0.9" }} className='nav-email'>
                            <i className='icon-black-envelope'></i>
                            <a className='ml-1' style={{ color: "white" }} href='mailto:carealpha247@gmail.com'>
                                carealpha247@gmail.com
                            </a>
                        </div>
                        <div className='hg-as-mrgn'>
                            <span className='hg-as'>
                                <a style={{ fontSize: "18px" }} className='hovicon' target='_blank' href='https://www.facebook.com/officialalphacare247'>
                                    <i style={{ opacity: "0.8", marginRight: "7px" }} className='icon-facebook-logo-circle'></i>
                                </a>
                                <a target='_blank' href='https://www.linkedin.com/in/alpha-care-155582241/' className='hovicon'>
                                    <i className='fa fa-linkedin'></i>
                                </a>
                                <a style={{ fontSize: "18px" }} target='_blank' href='https://instagram.com/alphacare247?igshid=MzNlNGNkZWQ4Mg==' className='hovicon'>
                                    <i style={{ opacity: "0.8", marginLeft: "7px" }} className='icon-instagram-circle'></i>
                                </a>
                            </span>
                        </div>
                    </header>
                    <div className={(window.innerWidth <= 890) ? "d-none" : "d-block"}>
                        <RenderMenu />
                    </div>
                </div>
                <div className={fix ? 'fixednav nav-top2' : 'navbarup nav-top2'} >
                    <Link to='./'><img className='img-logo' src={require("../images/logo2.png")} /></Link>
                    <div className='text-rlogo'>
                        <Link to='./about.js' className='text-mbar'>ABOUT US</Link>
                        <Link to='./blogs.js' className='text-mbar ml-1'>BLOGS</Link>
                ...
                <div className={NavMenu ? 'nav-menu nm-visible' : 'nav-menu'}>
                    <Link to='./about.js' style={{ display: "block", marginLeft: "16px" }} className='text-mbar-nav' onClick={() => updateMenu()}>ABOUT US</Link>
                    <Link to='./blogs.js' style={{ display: "block", marginLeft: "16px" }} className='text-mbar-nav blog-mbar mt-1' onClick={() => updateMenu()}>BLOGS</Link>
                    <div className='r-menuRes' >
                        <RenderMenu />
                    </div>
                </div>
            </div >
                ...
                <div style={{ display: 'block' }} className="modal modal-form" id="modalBookingForm">
                    <div style={{ maxWidth: "768px", borderRadius: '10px', minHeight: 'auto' }} className="modal-dialog">
                        <div className="modal-content">
                            <button style={{ zIndex: '6446' }} aria-label="Close" onClick={() => { setopenLogin(false); OpenLoginFun(false) }} className=" close" >
                            ...
                            <div className="container-modal" id="container">
                                <div className="form-container sign-in-container">
                                    <form method='POST' className={noField ? "form-modal d-none" : "form-modal"} onSubmit={submitForm}>
                                        ...
                                        <button style={{ width: "100%" }} className="btn-ap mt-2 mb-1" type='submit' name='getotp' onClick={PostData} >Get OTP</button>
